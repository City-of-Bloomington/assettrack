...
<s:form action="auctionItem" id="form_id" method="post">
  ...
  <p>* Required field <br />
	...
	<s:else>
		...
		<a href="<s:property value='#application.url'/>changeDispose.action?id=<s:property value='item.id' />&method_from=Auction" class="fn1-btn"> Change Dispose Method</a>			
	</s:else>
</s:form>
