...
public class Helper{
    ...
    static final long serialVersionUID = 1390L;	
    ...
    */
    ...
    //
    public final static Connection getConnectionSqlite(String sqliteDbFile){

	Connection con = null;
	if(sqliteDbFile == null || sqliteDbFile.equals("")){
	    return con; // null
	}
        try{
	...
	while(trials < 3 && !pass){
		...
		DataSource ds = (DataSource)envCtx.lookup("jdbc/MySQL_assets");
