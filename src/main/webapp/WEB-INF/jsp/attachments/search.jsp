...
<s:form action="attachSearch" method="post">
  ...
  <h3> Search Attachments </h3>
	<p>To add a new attachment, go to related Organization, Device, Monitor or Printer and click on the 'Attachments' button.
		</p>
	<div class="tt-row-container">
		...
		<dl class="fn1-output-field">
			<dt>Object Type </dt>
			<dd><s:radio name="uploadList.obj_type" value="%{uploadList.obj_type}" list="#{'-1':'All','Organization':'Organization','Device':'Device','Printer':'Printer','Monitor':'Monitor'}" />
			</dd>
		</dl>
		<dl class="fn1-output-field">
			<dt>Date </dt>
