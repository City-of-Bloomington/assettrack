...
<s:form action="employee" id="form_id" method="post">
  ...
  <s:elseif test="hasActionMessages()">
	...
	<dl class="fn1-output-field">
		<dt>Username</dt>
		<dd><s:textfield name="employee.username" size="10" value="%{employee.username}" /></dd>
	</dl>	
	<dl class="fn1-output-field">
		<dt>Full Name </dt>
		<dd><s:textfield name="employee.first_name" value="%{employee.first_name}" size="30" maxlength="70" /> </dd>
	</dl>
	<dl class="fn1-output-field">
		<dt>Last Name </dt>
		<dd><s:textfield name="employee.last_name" value="%{employee.last_name}" size="30" maxlength="70" /> </dd>
	</dl>
	<dl class="fn1-output-field">
		<dt>Office Phone </dt>
		<dd><s:textfield name="employee.office_phone" value="%{employee.office_phone}" size="20" maxlength="20" /> </dd>
	</dl>	
	<dl class="fn1-output-field">
		<dt>Roles</dt>
